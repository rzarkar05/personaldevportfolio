...
export const metadata: Metadata = {
	...
	authors: [{ name: 'Rishi Zarkar' }],
	creator: 'Rishi Zarkar',
	openGraph: {
		title: 'Rishi Zarkar - Full-Stack Developer Portfolio',
		description:
		...
		siteName: 'Rishi Zarkar - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Rishi Zarkar - Full-Stack Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
	...
	twitter: {
		...
		title: 'Rishi Zarkar - Full-Stack Developer',
		description:
			'Passionate full-stack developer creating complete web solutions. Explore my projects and technical expertise across the entire development stack.',
