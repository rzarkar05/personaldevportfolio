			...
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					...
					<p className="text-gray-400 max-w-2xl mx-auto">
						Looking for a full-stack developer who can architect and implement complete solutions? Let&apos;s connect!
					</p>
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:rzarka0422@gmail.com"
						...
						<a
							href="https://docs.google.com/document/d/1tUe4NM9ZxhFz2804GGrPgmHjP8z0bsxR_gWdqBXkKtM/edit?usp=sharing"
							target="_blank"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/rzarkar05"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/rishi-zarkar-083119212/"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
